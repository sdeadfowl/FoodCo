...
namespace FoodCo.Models
{
    public class UserRepository : IdentityUser
    {
        ...
        //public async Task<IEnumerable<Chat>> GetUserChatsByChatId(int applicantId, int messageId)
        //{
        //    ApplicationUser userApplicant = await Get(applicantId);
        //    Chat messageID = DB.UserChats.Get(messageId);
